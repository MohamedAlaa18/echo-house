                                ...
                                {['Sales Inquiry', 'Product Support', 'General Feedback'].map((option, index) => (
                                    <div key={index}>
                                        <label
                                            ...
                                            className={`block w-full cursor-pointer rounded-lg border border-gray-200 dark:border-gray-600 p-3 text-gray-600 dark:text-gray-100  hover:bg-orange-100 dark:hover:bg-orange-400 ${form.option === option ? 'bg-orange-200 dark:bg-orange-500' : ''}`}
                                            tabIndex={0}
                                        >
                                            <input
                                                className="sr-only"
